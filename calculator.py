...
class UserProfile:
    ...
    def get_domain(self):
        ...
        return parts[1]  # ERROR 12: IndexError — email.split("@") only has 2 parts (index 0,1)
...
def parse_config(config_str):
    ...
    db_port = config["database"]["port"]  # ERROR 13: KeyError — typo 'post' should be 'port'
...
def convert_to_int(value):
    ...
    try:
        ...
        return None  # Could not convert value to int
